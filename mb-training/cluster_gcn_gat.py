...
from models import *
# Define the header
header = ['dataset', 'model', 'batch_size', 'num_partition', 'shuffle', 'use_ddp', 'gpu_model', 'n_gpu', 'n_layers', 'n_hidden', 'head', 'test_accuracy', 'epoch_time', 'n_50_accuracy', 'n_50_tta', 'n_50_epoch', 'n_100_accuracy', 'n_100_tta', 'n_100_epoch']
...
def train(
    ...
    try:
        if proc_id == 0:
            ...
            data = ds, model_name, batch_size, num_partitions, shuffle, use_ddp, gpu_model, n_gpu, n_layers, n_hidden, num_heads, best_test_acc, epoch_time, n_50_accuracy, n_50_tta, n_50_epoch, n_100_accuracy, n_100_tta, n_100_epoch
            print(data)

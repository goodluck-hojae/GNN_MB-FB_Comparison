...
if __name__ == "__main__":
    ...
    if args.dataset == 'pubmed':
        ...
        data = (
            ogbn_papers100M_dataset.num_classes, train_ids, valid_ids, test_ids
        )
        model_params = (2, 128)
        batch_size = 20
        partition = 5000
    ...
    for s in shuffle:
        for d in use_ddp:
            ...
            print('Running parameters : ',args.dataset, b, p, f, s, d, args.gpu, l, h)
            mp.spawn(run, args=(nprocs, devices, g, data, args.mode, (args.dataset, b, p, f, s, d, args.gpu, l, h)), nprocs=nprocs, join=True)
            i+=1    
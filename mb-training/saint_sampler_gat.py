        ...
        for s in shuffle:
            for d in use_ddp:
                ...
                #                 for head in n_heads:
                    ...
                    print('Running parameters : ', ds, b, p, m, bu, s, d, n_g, l, h, head)
                    mp.spawn(run, args=(nprocs, devices, g, data, args.mode, (ds, b, p, m, bu, s, d, n_g, l, h, head)), nprocs=nprocs, join=True)
                    i += 1

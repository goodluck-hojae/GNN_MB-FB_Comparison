...
# Define the header
header = ['dataset', 'model', 'batch_size', 'num_partition', 'shuffle', 'use_ddp', 'gpu_model', 'n_gpu', 'n_layers', 'n_hidden', 'test_accuracy', 'epoch_time', 'n_50_accuracy', 'n_50_tta', 'n_50_epoch', 'n_200_accuracy', 'n_200_tta', 'n_200_epoch']
...
def train(
    ...
    try:
        if proc_id == 0:
            ...
            data = ds, model_name, batch_size, num_partitions, shuffle, use_ddp, gpu_model, n_gpu, n_layers, n_hidden, best_test_acc, epoch_time, n_50_accuracy, n_50_tta, n_50_epoch, n_200_accuracy, n_200_tta, n_200_epoch
            print(data)
